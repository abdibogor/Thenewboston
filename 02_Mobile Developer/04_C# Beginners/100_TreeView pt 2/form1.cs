...
namespace TreeView
{
    public partial class Form1 : Form
    {
        ...
        public void_button2_Click(object sender, EventArgs e)
        {
            //treeView1.SelectedMode.Remove();
            //treeView1.Nodes.Clear();
            RemoveChecked(treeView1.Nodes);
        }
        ListTreeNodes tnList = new List<TreeNodes>();
        void RemoveChecked(TreeNodeCollection tnt)
        {
